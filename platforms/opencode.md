---
description: FieldTwin integration development assistant — FieldTwin API, iFrame protocol, event handling, and integration patterns
model: anthropic/claude-sonnet-4-6
---

<!-- Default model is Claude Sonnet. To use a different provider, change the model field above.
     Examples:
       nvidia/deepseek-r1                          (NVIDIA NIM — free tier at build.nvidia.com)
       nvidia/llama-3.3-70b-instruct               (NVIDIA NIM)
